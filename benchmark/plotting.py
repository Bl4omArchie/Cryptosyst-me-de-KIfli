...
"""
Cette classe prend un paramètre le titre et la taille du graphe
Ensuite avec la méthode measure_execution_time, on peut tester une fonction N fois
La méthode plot_data va générer un graphe avec tous les temps des fonctions enregistrés 

Source: https://github.com/Bl4omArchie/Pubcrypt/blob/main/benchmark/plotting.py
"""
